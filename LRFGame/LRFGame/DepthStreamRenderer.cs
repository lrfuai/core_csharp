...
namespace LRFGame
{
    ...
    public class DepthStreamRenderer : Object2D
    {
        ...
        public DepthStreamRenderer(Game game, PeopleFollowerModule Follower)
            : base(game)
        {
            this.skeletonStream = new SkeletonStreamRenderer(game, this.SkeletonToDepthMap, Follower);
